...
////int[][] array1={{8,6,7},{5,2,0},{3,1,4}};	//initial state as an array
//int[][] array2={{0,1,2},{3,4,5},{6,7,8}};	//goal state as an array
//
//Sq8State initialState,goalState;	//the initial and goal states
//initialState=new Sq8State(array1);	//*** Remove this statement but create a Sq8State object here.
//goalState=new Sq8State(array2);		//*** Remove this but create a Sq8State object here.
//
